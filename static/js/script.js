...
(function () {
	...
	$(function () {
			...
			var regularConstraintsMessages = [
				{
					...
					newMessage: "本欄位為必填項目，請詳細填妥。"
				},
				{
					type: regula.Constraint.Email,
					newMessage: "該電子信箱不是有效的電子信箱。"
				},
				{
					type: regula.Constraint.Numeric,
					newMessage: "本欄位只需要填寫數字。"
				},
				{
		...
		function initMaps() {
			...
			$.getScript('http://maps.google.com/maps/api/js?key=AIzaSyAhG-MrWZXoqYH09RCI2ki-XwWaUuk-jBE&sensor=false&libraries=geometry,places&v=3.7', function () {
				...
				for (var i = 0; i < plugins.maps.length; i++) {
					...
					var map = new google.maps.Map(plugins.maps[i].querySelectorAll(".google-map")[0], {
						...
						styles: styles,
						scrollwheel: false,
						center: { lat: 23.587835, lng: 119.581173 }
					});
...
function sendemail() {
	...
	emailjs.send("service_ub7zh5v", "template_cz5dvw2", emailData)
